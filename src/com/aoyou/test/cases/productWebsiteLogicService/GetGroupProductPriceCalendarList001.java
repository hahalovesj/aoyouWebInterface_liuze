...
import com.aoyou.test.templates.productWebsiteLogicService.GetGroupProductPriceCalendarList;
import com.aoyou.test.listener.TestngRetry;


public class GetGroupProductPriceCalendarList001 extends TestBase{
	...
	public void getGroupProductPriceCalendarList001(){

		List<String> productID = Action.getProductID(1, "2");
		List<String> price = null;
		test = new GetGroupProductPriceCalendarList();
