...
public class GetAirSolutionViewList001 extends TestBase{
	...
	public void getAirSolutionViewList001(){
		...
		if(test.getStatus()==200){
			...
			checkPoint.notEquals(childPrice,"0.00","childPrice为0.00");
			checkPoint.notEquals(childPrice,"0","childPrice为0");
			checkPoint.notEquals(childPrice,"1.00","childPrice为1.00");
			checkPoint.notEquals(childPrice,"1","childPrice为1");
			checkPoint.notEquals(childPrice,null,"childPrice为null");
