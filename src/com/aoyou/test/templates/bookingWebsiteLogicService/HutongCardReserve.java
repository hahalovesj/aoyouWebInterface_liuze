...
public class HutongCardReserve extends NoInputParamTemplate{
	...
	public void setRequestData() {
		...
		requestData.append("<cyts:Contact>测试</cyts:Contact>");
		...
		requestData.append("</arr:KeyValueOfstringArrayOfKeyValueOfstringstringty7Ep6D1>");
		requestData.append("</cyts:Cooperation>");
		requestData.append("<cyts:CustomerID>11243740</cyts:CustomerID><cyts:CustomerName>测试</cyts:CustomerName>");
		...
		requestData.append("<cyts:Contactor>测试</cyts:Contactor>");
