...
public class GetGroupProductPriceCalendar extends NoInputParamTemplate{
	...
	public void setHeaders() {
		headers.put("SOAPAction","http://tempuri.org/IPackageProductLogicService/GetGroupProductPriceCalendar");
	...
	public void setRequestData() {
		...
		requestData.append("<tem:GetGroupProductPriceCalendar>");
