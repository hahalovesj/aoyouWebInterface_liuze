...
public class GetAirSolutionViewList extends WebSerivceTemplate{
	...
	public void setHeaders() {
		headers.put("SOAPAction","http://tempuri.org/ICombinedProductLogicService/GetAirSolutionViewList");		
	}
	...
	public void setRequestData() {
		...
		requestData.append("<tem:GetAirSolutionViewList>");
