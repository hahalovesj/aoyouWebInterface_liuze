...
public class GetOrderRoomNumber extends WebSerivceTemplate{
	...
	public void setHeaders() {
		headers.put("SOAPAction", "http://tempuri.org/IOrderService/GetOrderRoomNumber");
	}
	@Override
	...
	public void setRequestData() {
		...
		requestData.append("<tem:GetOrderRoomNumber>");
