...
public class GetOrderSubType extends WebSerivceTemplate{
	...
	public void setHeaders() {
		headers.put("SOAPAction", "http://tempuri.org/IOrderService/GetOrderSubType");
	}
	@Override
	...
	public void setRequestData() {
		...
		requestData.append("<tem:GetOrderType>");
