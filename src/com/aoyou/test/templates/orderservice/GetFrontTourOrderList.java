...
public class GetFrontTourOrderList extends WebSerivceTemplate{
	...
	public void setHeaders() {
		headers.put("SOAPAction", "http://tempuri.org/IOrderService/GetFrontTourOrderList");
	}
	@Override
	...
	public void setRequestData() {
		...
		requestData.append("<tem:GetFrontTourOrderList>");
