...
public class GetGroupOrderFeeDetail extends WebSerivceTemplate{
	...
	public void setHeaders() {
		headers.put("SOAPAction", "http://tempuri.org/IOrderService/GetGroupOrderFeeDetail");
	}
	@Override
	...
	public void setRequestData() {
		...
		requestData.append("<tem:GetGroupOrderFeeDetail>");
