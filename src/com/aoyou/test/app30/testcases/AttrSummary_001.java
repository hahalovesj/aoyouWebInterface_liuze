...
import com.aoyou.test.app.request.AttrSummaryRequest;
...
public class AttrSummary_001 extends TestBase{
	...
	@Test
	public void attrSummary_001(){
		
		this.test=new AttrSummaryRequest();
		this.test.sendPost();
		...
		this.checkPoint.result("[执行时间:"+runTime+"ms]景点编号["+ticketIndexParamModel.TPID+"]的景点介绍获取成功");
	}
}
